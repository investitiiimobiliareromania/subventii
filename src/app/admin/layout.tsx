  ...
  return (
    <div className="min-h-screen bg-slate-100 flex flex-col font-sans">
      <header className="bg-slate-900 text-white px-6 py-4 flex items-center justify-between shadow-md">
        <div className="flex items-center gap-3">
          <Link href="/admin" className="font-extrabold text-lg tracking-tight text-white">
            AiX Educational Intelligence <span className="text-emerald-400 font-mono text-xs">CMS Admin</span>
          </Link>
        </div>
      ...
      <footer className="border-t border-slate-200 bg-white py-4 text-center text-xs text-slate-500">
        AiX Educational Intelligence Internal Administration System v1.0 • Toate modificările sunt jurnalizate.
      </footer>
    </div>
  );
}

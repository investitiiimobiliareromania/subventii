  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <section aria-label="Introducere și sumar metrici" className="border-b border-slate-200/80 bg-slate-50/50 py-12 md:py-16">
          <div className="mx-auto max-w-5xl px-4 text-center sm:px-6">
            <span className="mb-3 inline-block rounded-full bg-emerald-100 px-3.5 py-1 text-xs font-bold text-emerald-950 border border-emerald-200">
            ...
            <p className="mx-auto mb-8 max-w-2xl text-sm leading-relaxed text-slate-700 sm:text-base">
            ...
            <div className="mx-auto grid max-w-4xl grid-cols-2 gap-4 rounded-xl border border-slate-200 bg-white p-4 text-center shadow-xs sm:grid-cols-4">
              <div>
                ...
                <span className="text-[11px] font-semibold text-slate-700">Programe monitorizate</span>
              </div>
              <div>
                <span className="block text-2xl font-black text-emerald-800">
                  {openCount}
                </span>
                <span className="text-[11px] font-semibold text-slate-700">Apeluri deschise</span>
              </div>
              <div>
                <span className="block text-2xl font-black text-slate-900">{countiesCount}</span>
                <span className="text-[11px] font-semibold text-slate-700">Județe acoperite</span>
              </div>
              <div>
                <span className="block text-2xl font-black text-slate-900">{instCount}</span>
                <span className="text-[11px] font-semibold text-slate-700">Instituții monitorizate</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <section aria-label="Principii de funcționare" className="border-t border-slate-200 bg-slate-50/60 py-12">

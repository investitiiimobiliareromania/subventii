...
export function EcosystemNav() {
  ...
  return (
    <div className="relative inline-block text-left self-start" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute left-0 lg:left-auto lg:right-0 mt-2 w-80 sm:w-96 max-w-[calc(100vw-2rem)] rounded-2xl bg-slate-900 border border-slate-800 p-4 shadow-2xl z-50 animate-in fade-in-50 zoom-in-95 box-border">
